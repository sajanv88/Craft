...
public sealed class CraftKeycloakRoutesTest
{
    ...
    [Fact(
        DisplayName = "Verify Keycloak module default endpoints are registered."
    )]
    public async Task Test2()
    {
        ...
        // Act
        var endpointDataSource = services
        ...
        var keycloakModule =
            host.Services.GetRequiredService<KeycloakModule.KeycloakModule>();
