...
public class CraftLocalizationModuleTest
        ...
        IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        Console.WriteLine(
            $"Using database connection string: {_fixture.ConnectionString}"
        );
        ...
        _endpointDataSource =
            _scope.ServiceProvider.GetRequiredService<EndpointDataSource>();
        _httpClient = _scope
    ...
    [Fact(
        DisplayName = "Craft Localization Module default endpoints are registered."
    )]
    public void Test1()
    {
        ...
        Assert.Contains(
            "HTTP: GET /api/locales/ => GetLocalizationsAsync",
            routes
        );
        Assert.Contains(
            "HTTP: PUT /api/locales/ => CreateLocalesAsync",
            routes
        );
        Assert.Contains(
            "HTTP: GET /api/locales/{id} => GetLocalizationAsync",
            routes
        );
        Assert.Contains(
            "HTTP: PATCH /api/locales/ => UpdateLocalesAsync",
            routes
        );
        Assert.Contains(
            "HTTP: DELETE /api/locales/{id} => DeleteLocalesAsync",
            routes
        );
        Assert.Contains(
            "HTTP: GET /api/locales/all-cultures => ListAllCultures",
            routes
        );
        Assert.Contains(
            "HTTP: GET /api/locales/culture/{code} => GetCultureDetailAsync",
            routes
        );
    }

    [Fact(
        DisplayName = "Craft Localization Module - ListAllCultures - Should return all cultures"
    )]
    public async Task Test2()
    {
        var cultures = await _httpClient.GetFromJsonAsync<
            IReadOnlyList<CultureCodeAndDetailDto>
    ...
    [Fact(
        DisplayName = "Craft Localization Module - CreateLocalesAsync - Should create a new locale"
    )]
    public async Task Test3()
    {
        var createLocaleDto = new CreateLocaleDto(
            "ta",
            "title",
            "ஹலோ உள்ளூர்மயமாக்கல் தொகுதி"
        );
    ...
    [Fact(
        DisplayName = "Craft Localization Module - Get culture details by code - Should return culture details otherwise null"
    )]
    public async Task Test4()
    {
        var culture =
            await _httpClient.GetFromJsonAsync<LocaleWithCultureDetailDto>(
                "/api/locales/culture/ta"
            );
        ...
        culture =
            await _httpClient.GetFromJsonAsync<LocaleWithCultureDetailDto>(
                "/api/locales/culture/blabla"
            );
        Assert.Null(culture);
    }

    [Fact(
        DisplayName = "Craft Localization Module - GetLocalizationAsync - Should return a locale by id"
    )]
    public async Task Test5()
    {
        ...
        var locale = await _httpClient.GetFromJsonAsync<LocaleDto>(
            $"/api/locales/{guid}"
        );
    ...
    [Fact(
        DisplayName = "Craft Localization Module - CreateLocalesAsync - Should throw a bad request exception when passed invalid data"
    )]
    public async Task Test6()
    {
        var createLocaleDto = new CreateLocaleDto(
            "unknown-culture-code",
            "title",
            "ஹலோ உள்ளூர்மயமாக்கல் தொகுதி"
        );
    ...
    [Fact(
        DisplayName = "Craft Localization Module - UpdateLocalesAsync - Should update a locale"
    )]
    public async Task Test7()
    {
        ...
        response.EnsureSuccessStatusCode();
        var guid = await response.Content.ReadFromJsonAsync<Guid>();
        var updateLocaleDto = new UpdateLocaleDto(
            guid,
            "en-US",
            "nav_menu",
            "About"
    ...
    [Fact(
        DisplayName = "Craft Localization Module - UpdateLocalesAsync - Should throw a bad request exception when passed invalid data"
    )]
    ...
    [Fact(
        DisplayName = "Craft Localization Module - DeleteLocalesAsync - Should delete a locale"
    )]
    ...
    [Fact(
        DisplayName = "Craft Localization Module - DeleteLocalesAsync - Should throw a not found exception when locale not found"
    )]
    public async Task Test10()
    {
        ...
        Assert.Equal(
            $"The locale with id '{guid}' was not found",
            error.Message
        );
    }

    [Fact(
        DisplayName = "Craft Localization Module - GetLocalizationsAsync - Should return paginated localizations"
    )]
    public async Task Test11()
    {
        ...
        data = await _httpClient.GetFromJsonAsync<PaginatedResponse<LocaleDto>>(
            "/api/locales?page=0&pageSize=2"
        );
    ...
    [Fact(
        DisplayName = "Craft Localization Module - GetLocalizationsAsync - Should return empty list when no localizations found"
    )]
    public async Task Test12()
    {
        var data = await _httpClient.GetFromJsonAsync<
            PaginatedResponse<LocaleDto>
        >("/api/locales?cultureCode=unknown-culture-code");
